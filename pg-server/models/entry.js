...
const SQLCODE = "CREATE TABLE entries(entryId SERIAL PRIMARY KEY, Title VARCHAR(40) not null, Entry TEXT not null, type entryType, diaryId INT, FOREIGN KEY (diaryId) REFERENCES diaries (diaryId))";
